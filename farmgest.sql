...
--
-- Host: 127.0.0.1
-- Generation Time: 15-Maio-2015 às 22:03
...
(2, '18', NULL, 5, 'kg', 200, '4', '2015-05-01 00:00:00', NULL, 1, 1, 1);
...
(5, 'TESTE', 1, '0000-00-00', NULL, 'Active', NULL, 1, NULL, NULL, NULL, NULL, NULL, 2, 0),
(6, 'dasdasdsa', 1, '0000-00-00', NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 2, 0),
(7, 'sasA', 1, '0000-00-00', NULL, 'Active', NULL, 1, NULL, NULL, NULL, NULL, NULL, 2, 0),
(8, 'dsds', 1, '0000-00-00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1),
(9, 'cacacaca', 0, '0000-00-00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1),
(10, 'cacacaca', 1, '2014-12-12', '2014-12-13', 'Active', NULL, 1, NULL, NULL, NULL, NULL, '1', 2, 1),
(11, '', 0, '0000-00-00', NULL, 'Active', 'Organic', NULL, NULL, NULL, NULL, NULL, NULL, 2, 0),
(12, '', 0, '0000-00-00', NULL, 'Active', 'Organic', NULL, NULL, NULL, NULL, NULL, NULL, 2, 0);
...
INSERT INTO `prod_season_problems` (`id`, `id_season`, `name`, `type`, `status`, `description`, `notes`) VALUES
(1, 1, 'Podridão castanha', 'Disease', 'active', 'As plantas apresentao\r\nsds\r\nda\r\ndasdas', '12-abril - muito mau'),
(2, 1, 'Rebordo Queimado', 'Other', 'active', 'Apanharam sol em demasia e ficaram com problemas nas folhas', 'sasa'),
(3, 1, 'Qualquer coisa', 'Disease', 'active', 'adsa', 'dsadas'),
(4, 2, 'Humidade Espinafres', 'Weed', 'closed', 'adsa', 'dsadas'),
(5, 1, 'Manchas castanhas', 'Disease', 'active', 'adsa', 'dsadas');
...
INSERT INTO `prod_treatment` (`id`, `id_package`, `id_problem`, `active_substance`, `recomended_dose`, `quantity_used`, `security_interval`, `persistence`, `function`, `id_farm`, `id_entity`, `notes`) VALUES
(2, 19, 5, 'dsdasd', '10', 0.01, 12, 4, 'Fungicida', 2, 1, ''),
(3, 19, 1, 'dasdasdas', '10', 0.01, 12, 4, 'Fungicida', 2, 1, ''),
(4, 19, 2, 'dsdasd', '10', 0.01, 12, 4, 'Afídeos', 2, 1, '');
...
INSERT INTO `rep_configuration` (`id`, `query_code`, `query_sql`, `title`, `template_location`, `start_line`, `title_cell`, `status`, `id_entity`, `id_farm`) VALUES
(1, 'queryFinances', 'Select id_type as Type, description AS Description, n_document AS NumberDocument, total_cost as TotalCost, date_document AS DateDocument, date_efective_payment AS PaymentDay, payment_type AS PaymentType from fin_expenses', 'All Expenses', 'C:\\Users\\Ricardo\\Desktop\\cenas.xls', 10, 'B', 'Active', 1, 1),
(2, 'queryRastreability', 'Select * from prod_season', 'All Seasons', 'C:\\Users\\Ricardo\\Desktop\\season.xls', 10, 'B', 'Active', 1, 1);
