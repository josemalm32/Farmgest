                    ...
                    <div class="row">
                        ...
                        <!-- small box -->
                            <div class="small-box bg-aqua">
                                ...
                                <a href="<?=base_url()?>index.php/dashboard/entity_menu" class="small-box-footer">
                        ...
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-green">
                                ...
                                <a href="<?=base_url()?>index.php/dashboard/farm_menu" class="small-box-footer">
                                    More info <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
                        ...
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-yellow">
                                ...
                                <a href="<?=base_url()?>index.php/dashboard/season_menu" class="small-box-footer">
                                    More info <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
